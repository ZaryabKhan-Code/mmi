...
import { Box, Card, Typography, Button, IconButton, TextField, InputAdornment, Divider, Select, MenuItem, Grid, FormControl, FormHelperText } from '@mui/material';
...
const UserProfile = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            formData.append('areaOfInterest', data.interest)
